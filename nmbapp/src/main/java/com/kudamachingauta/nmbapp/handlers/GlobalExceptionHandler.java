package com.kudamachingauta.nmbapp.handlers;

import com.kudamachingauta.nmbapp.dto.ApiResponse;
import com.kudamachingauta.nmbapp.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ApiResponse handleValidationException(MethodArgumentNotValidException e){
        ...
        return new ApiResponse(400, "BAD REQUEST", errors);
    }

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(TransactionFailedException.class)
    public ApiResponse handleTransactionFailedException(TransactionFailedException e){
        return new ApiResponse(400, e.getLocalizedMessage());
    }
